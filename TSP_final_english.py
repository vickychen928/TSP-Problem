...
def draw_time(DP_avg_time, Genetic_avg_time):
    ...
    plt.xticks(vertex)
    plt.title("Algorithm Average Time") # title
    plt.ylabel("Average Time(second)") # y label
    plt.xlabel("vertex number") # x label
...
def draw_error(error):
    ...
    plt.title("Genetic Algorithm Error") # title
    plt.ylabel("Average Relative Error") # y label
    plt.xlabel("vertex number") # x label
    plt.grid(True)
